import { ADD_PRODUCT_CART, REMOVE_PRODUCT_CART, INCREMENT_COUNTER, DECREMENT_COUNTER, INCREMENT_QUANTITY, DECREMENT_QUANTITY, SET_INITIAL_CART, SET_INITIAL_ITEMS, CLEAN_CART, TOTAL_PRICE, SET_STATE } from './action.js';
